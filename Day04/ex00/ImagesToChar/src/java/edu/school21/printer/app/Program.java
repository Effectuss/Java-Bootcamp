...
public class Program {
    public static void main(String[] args) {
        try {
            ...
            ConsoleImagePrinter imagePrinter = new ConsoleImagePrinter(new File(args[2]), args[0].charAt(0), args[1].charAt(0));
            imagePrinter.print();
    ...
    private static void checkProgramArgument(String[] inputArgs) throws IllegalArgumentException {
        if (inputArgs.length != 3) {
            throw new IllegalArgumentException("Input arguments count must be 3");
        }
